...
function Home() {
  ...
  const [avatar, setAvatar] = useState('https://res.cloudinary.com/dvmodwtsk/image/upload/v1696321873/nv1uea2glgphswm4yadw.jpg');
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.card} onPress={() => { navigation.navigate(item.navigation, { category: item.name, userData:userData }) }}>
